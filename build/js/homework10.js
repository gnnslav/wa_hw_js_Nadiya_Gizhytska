...
function svetofor() {
	var switchOnOff = document.querySelector('.switch');
	var lamps = document.querySelectorAll('.lamps');
	var lampRed = document.querySelector('.lamp-red');
	var lampYellow = document.querySelector('.lamp-yellow');
	var lampGreen = document.querySelector('.lamp-green');
