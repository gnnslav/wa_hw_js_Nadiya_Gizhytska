...
// Task 5
var maxsumma = function maxsumma(obj) {
	var max = 0;
	for (var key in obj) {
...
btn8.onclick = function () {
	var elem = document.querySelector('#item').value;
	itemArr.push(elem);
	output8.innerHTML = itemArr;

	var itemSum = itemArr.reduce(function (sum, elem) {
		return +sum + +elem;
	});
	console.log(itemArr);
	console.log(itemSum);
...
var dateTask12 = new Date(2012, 1, 20, 3, 12);
console.log(dateTask12);

//Task 13

var dateTask13 = new Date(2012, 0, 3);
